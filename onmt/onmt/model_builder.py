...
def build_embeddings(opt, text_field, for_encoder=True):
    ...
    if hasattr(opt, 'freeze_word_vecs_enc'):
        opt.fix_word_vecs_enc = opt.freeze_word_vecs_enc

    if hasattr(opt, 'freeze_word_vecs_dec'):
        opt.fix_word_vecs_dec = opt.freeze_word_vecs_dec
